<%-- 
    ...
    Created on : Jan 3, 2020, 3:00:23 PM
...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="#"> <img src="https://img.icons8.com/ios/32/000000/rhombus-filled.png"> SALAFLI</a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    ...
                    <div class="container shadow-sm p-3 mb-5 bg-white rounded">
                        <div class="row">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="edit-box col-2">
                                        <a href="UpdateCar.htm?idCar${list.IDCar}?idClient=${IDClient}">Reserve</a>
                                    </div>
